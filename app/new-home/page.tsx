...
/* ─── DATA ─── */
const DESTINATIONS = [
  { name: "Hunza Valley",       region: "Gilgit-Baltistan", nights: "7 nights",  image: "https://aurigaventure.com/wp-content/uploads/2026/01/Lower-Kachura-Lake-and-Shangrila-Resort-560x460.jpg",      price: "From $1,300", tripName: "THE JEWEL OF THE KARAKORAM"          },
  { name: "Skardu Valley",      region: "Gilgit-Baltistan", nights: "9 nights",  image: "https://aurigaventure.com/wp-content/uploads/2026/01/Nanga-Parbat-and-Sheosar-Lake-scaled.jpg",                  price: "From $1,300", tripName: "WHERE THE KARAKORAM MEETS SILENCE"   },
  { name: "Chitral",            region: "KPK",              nights: "7 nights",  image: "https://aurigaventure.com/wp-content/uploads/2026/01/org_364545bcd22687ac_1592367926000-2048x1536.jpg",          price: "From $1,900", tripName: "ANCIENT KINGDOMS OF THE HINDU KUSH"  },
  { name: "Ghizer Valley",      region: "Gilgit-Baltistan", nights: "6 nights",  image: "https://aurigaventure.com/wp-content/uploads/2019/01/Dunsa-Valley-Tormik-scaled-e1772014273230-560x460.jpg",     price: "From $1,800", tripName: "PAKISTAN'S MOST UNSPOILED VALLEY"    },
  { name: "Rakaposhi",          region: "Nagar Valley",     nights: "5 nights",  image: "https://aurigaventure.com/wp-content/uploads/2014/10/IMG_9669-560x460.jpg",                                       price: "From $1,350", tripName: "BASECAMP AT THE FOOT OF A GIANT"     },
  { name: "Astore Valley",      region: "Gilgit-Baltistan", nights: "6 nights",  image: "https://aurigaventure.com/wp-content/uploads/2026/01/Glamp-Pakistan-at-Deosai-scaled-e1769679760930.jpg",         price: "From $1,400", tripName: "REMOTE, SERENE, UNFORGETTABLE"        },
  { name: "Deosai Plains",      region: "Skardu",           nights: "4 nights",  image: "https://aurigaventure.com/wp-content/uploads/2026/01/Glamping-at-Deosai-scaled-e1771302772481.jpg",               price: "From $1,500", tripName: "GLAMPING ON THE ROOF OF THE WORLD"   },
  { name: "Fairy Meadows",      region: "Diamer",           nights: "3 nights",  image: "https://aurigaventure.com/wp-content/uploads/2014/10/DJI_0122-scaled.jpg",                                        price: "From $1,200", tripName: "IN THE SHADOW OF NANGA PARBAT"        },
];
    ...
    <section id="destinations" className="bg-[#1a1a1a] py-0 overflow-hidden">
      ...
      >
        {DESTINATIONS.map((d, i) => (
          ...
          >
            <a href="#contact" className="block relative overflow-hidden" style={{ aspectRatio:"3/4.2" }}>
